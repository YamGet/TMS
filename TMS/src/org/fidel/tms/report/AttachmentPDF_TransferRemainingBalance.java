...
public class AttachmentPDF_TransferRemainingBalance {
	...
	private static List<FrightOrder> parentFrightOrderInfo;
	
	private static double return_amount, coupon_transfer_amount;
		
	public static byte[] generatePDFDocument(String FileName, List<FrightOrder> frightOrderInfo, List<FrightOrder> parentFrightOrderInfo, double return_amount, double coupon_transfer_amount){
			
			setFrightOrderInfo(frightOrderInfo);
			
			setReturn_amount(return_amount);
			
			setCoupon_transfer_amount(coupon_transfer_amount);
			
			setParentFrightOrderInfo(parentFrightOrderInfo);
		...
		public static PdfPTable PDFBodyContent(){
			...
			insertCell(pdfContent, "Transfered From ", Element.ALIGN_LEFT, 3, 1, tblContentFont);
			...
			insertCell(pdfContent, parentFrightOrderInfo.get(0).getDrivers().getFname() + " " + frightOrderInfo.get(0).getDrivers().getMname(), Element.ALIGN_LEFT, 1, 1, tblContentFont);
			...
			insertCell(pdfContent, parentFrightOrderInfo.get(0).getTruckInformation().getTruck_plate_no(), Element.ALIGN_LEFT, 1, 1, tblContentFont);
			...
			insertCell(pdfContent, parentFrightOrderInfo.get(0).getTrailInformation().getTrail_plate_no(), Element.ALIGN_LEFT, 1, 1, tblContentFont);
			...
			insertCell(pdfContent, parentFrightOrderInfo.get(0).getFon(), Element.ALIGN_LEFT, 1, 1, tblContentFont);
			...
			insertCell(pdfContent, parentFrightOrderInfo.get(0).getDate_from(), Element.ALIGN_LEFT, 1, 1, tblContentFont);
			
			insertCell(pdfContent, "Transfered To ", Element.ALIGN_LEFT, 3, 1, tblContentFont);
			...
			insertCell(pdfContent, "Transfered Amount Balance - ", Element.ALIGN_LEFT, 1, 1, tblContentFont);
			...
			insertCell(pdfContent, "Transfered Coupon Amount Balance - ", Element.ALIGN_LEFT, 1, 1, tblContentFont);
			insertCell(pdfContent, String.format("%,.2f", getCoupon_transfer_amount()), Element.ALIGN_LEFT, 1, 1, tblContentFont);
		...
		public static PdfPTable PDFHeaderContent(){
			...
			cell = new PdfPCell(new Phrase("Advance Payment Remaining Balance Transfer Form", headerFont));
			cell.setColspan(1);
			cell.setBorder(0);
			cell.setHorizontalAlignment(Element.ALIGN_CENTER);
			pdfHeader.addCell(cell);
		...
		public static PdfPTable PDFFooterContent(){
			...
			cell = new PdfPCell(new Phrase("  TRANSFERED BY. ___________________ ", footerFont));
			cell.setColspan(1);
			cell.setBorder(0);			
...
//		}
		...
		public static void setFrightOrderInfo(List<FrightOrder> frightOrderInfo) {
			AttachmentPDF_TransferRemainingBalance.frightOrderInfo = frightOrderInfo;
		}
		...
		public static void setReturn_amount(double return_amount) {
			AttachmentPDF_TransferRemainingBalance.return_amount = return_amount;
		}

		public static List<FrightOrder> getParentFrightOrderInfo() {
			return parentFrightOrderInfo;
		}

		public static void setParentFrightOrderInfo(List<FrightOrder> parentFrightOrderInfo) {
			AttachmentPDF_TransferRemainingBalance.parentFrightOrderInfo = parentFrightOrderInfo;
		}

		public static double getCoupon_transfer_amount() {
			return coupon_transfer_amount;
		}

		public static void setCoupon_transfer_amount(double coupon_transfer_amount) {
			AttachmentPDF_TransferRemainingBalance.coupon_transfer_amount = coupon_transfer_amount;
		}
}
