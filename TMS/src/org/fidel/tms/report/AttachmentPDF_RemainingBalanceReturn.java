...
public class AttachmentPDF_RemainingBalanceReturn {
	...
	public static byte[] generatePDFDocument(String FileName, List<FrightOrder> frightOrderInfo, double return_amount){
		...
		public static PdfPTable PDFBodyContent(){
			...
			insertCell(pdfContent, "Return Amount Balance - ", Element.ALIGN_LEFT, 1, 1, tblContentFont);
		...
		public static PdfPTable PDFHeaderContent(){
			...
			cell = new PdfPCell(new Phrase("Advance Payment Remaining Balance Return Form", headerFont));
			cell.setColspan(1);
			cell.setBorder(0);
			cell.setHorizontalAlignment(Element.ALIGN_CENTER);
			pdfHeader.addCell(cell);
		...
		public static PdfPTable PDFFooterContent(){
			...
			cell = new PdfPCell(new Phrase("  RECEIVED BY. ___________________ ", footerFont));
			cell.setColspan(1);
			cell.setBorder(0);			
...
//		}
		...
		public static void setFrightOrderInfo(List<FrightOrder> frightOrderInfo) {
			AttachmentPDF_RemainingBalanceReturn.frightOrderInfo = frightOrderInfo;
		}
		...
		public static void setReturn_amount(double return_amount) {
			AttachmentPDF_RemainingBalanceReturn.return_amount = return_amount;
		}
}
