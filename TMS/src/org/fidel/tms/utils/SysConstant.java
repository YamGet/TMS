...
public class SysConstant {
	...
	public static final String ORGANIZATION_NAME = "TMS_Tilahun";
	
	public static final String SYS_NAME = "TMS";
	...
	public static final String MACADD_CONSTANT_3 = "64-00-6A-62-AA-83";//meron pc
	
	public static final String SECURITY_FILE_PATH = "C:/tms_system_file/";
	
	public static final String DATABASE_BACKUP_FOLDER = "C:\\tms_system_file\\dbBackup\\";
	...
	public static final String DATABASE_NAME = "tms_tilahun";
	...
	public static final String ORGANIZATION_FULL_NAME = "Tilahun Mesafent Transport";
	...
	public static final String CERT_PDF_PATH = "C:/TMS_Report/";
	
	public static final String ORGANIZATION_ADDRESS = "";
	
	public static final String ORGANIZATION_EMAIL = "";
	
	public static final String ORGANIZATION_LOCATION = "Addis Ababa, Ethiopia";
	...
	public static final String REPORT_NOTE_16 = "Loading Unloading Difference Form";
