...
<div style="width: 100%;" align="center">
	<div class="alert alert-danger" style="width: 400px; height: 200px; padding-top: 30px; font-size: 20px; text-align: center;">
		<c:url value="/resources/images/msg_error.jpeg" var="error"/>
		<img alt="warning" src="${error}" width="60px;"> <br/><br/> Database backup process failed. Please try again.
	</div>
</div>
</body>
</html>