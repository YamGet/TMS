...
<body>
	...
	<td style="padding-top: 4px;">
		...
		<select id="truck_type" onchange="filterPaymentNotCollectedBeforeRequest(this.value, '${loader}')" class="form-control" style="height: 40px;">
		...
		<div class="btn btn-default" onclick="rptPDF_generatePaymentNotCollectedBeforeRequest('${loader}')">
		...
		<div class="btn btn-default" onclick="excel_generatePaymentNotCollectedBeforeRequest('${loader}')">
			<table align="center"><tr><td>			
	...
	<div id="paymentReportContent">
		...
		<jsp:include page="payment_not_collected_before_request_content.jsp"/>
