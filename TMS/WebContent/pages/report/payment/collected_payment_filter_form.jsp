			...
			<td style="padding-bottom: 5px;">
				...
				<table><tr>
					...
					<td style="padding-left: 10px;">					
						<button type="submit" class="btn btn-default" onclick="generateCollectedPaymentReport('${loader}')">Generate</button>
					</td>					
					<td width="80px;">&nbsp;</td><td>
...
<!-- 						</div> -->
					...
					<td style="padding-top: 4px;">
						<div class="btn btn-default" onclick="rptPDF_generateCollectedPaymentReport('${loader}')">
					...
					<td>&nbsp;</td><td style="padding-top: 4px;">
						...
						<div class="btn btn-default" onclick="excel_generateCollectedPaymentReport('${loader}')">
							<table align="center"><tr><td>			
