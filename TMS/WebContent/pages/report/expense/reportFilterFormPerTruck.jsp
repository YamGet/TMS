	...
	<table width="100%">
		<tr>
			<td style="font-weight: bold;">
				Report - Revenue And Expense Per Truck
			</td>
		</tr>
		<tr>
			<td>
		...
		<tr>
			<td style="padding-bottom: 5px;">
				...
				<table><tr>
					...
					<td> Date From </td> <td style="padding-left: 10px;"> <input id="date_from" type="text" class="form-control" placeholder="yyyy-MM-dd" style="width: 105px;"> </td>
					<td style="width: 10px;">&nbsp;</td>
					<td> Date To </td> <td style="padding-left: 10px;"> <input id="date_to" type="text" class="form-control" placeholder="yyyy-MM-dd" style="width: 105px;"> </td>
					...
					<td style="padding-left: 10px;">			
						<button type="submit" class="btn btn-default" onclick="generateRevenueExpensePerTruckReport('${loader}')">Generate</button>
					</td>
					<td width="80px;">&nbsp;</td><td>
...
<!-- 						</div> -->
						...
						<div class="btn btn-default" onclick="rptPDF_generateRevenueExpensePerTruck('${loader}')">
					...
					<td>&nbsp;</td><td style="padding-top: 4px;">
						...
						<div class="btn btn-default" onclick="excel_generateRevenueExpensePerTruck('${loader}')">
							<table align="center"><tr><td>			
