...
<body>
	...
	<table><tr><td style="padding-top: 4px;">
		...
		<select id="truck_type" onchange="filterDailyActivities(this.value, '${loader}')" class="form-control" style="height: 40px;">
		...
		<div class="btn btn-default" onclick="rptPDF_generateTruckDailyActivity('${loader}')">
		...
		<div class="btn btn-default" onclick="excel_generateTruckDailyActivity('${loader}')">
			<table align="center"><tr><td>			
	...
	<div id="filteredReportContent">
		...
		<jsp:include page="daily_activities_content.jsp"/>
