...
<body>
	...
	<table class="table table-hover">
		...
		<c:forEach var="relatedUrl" items="${relatedUrl}">
			<tr>
				<td> ${relatedUrl.description} </td>
				<td> ${relatedUrl.url} </td>
				<td> <span style="color: #2c73e9; cursor: pointer; text-align: center;" onclick="unrelateURL('${loader}', '${relatedUrl.usersRoleModuleRelation.urmr_id}', '${relatedUrl.su_id}', '${m_id}', '${ur_id}')"> Delete </span> </td>
			</tr>
		</c:forEach>
	</table>
