...
<%-- 			<frm:form method="post" commandName="Drivers">				 --%>
				...
				<div class="form-group">
					<label for="userrole_status">Drivers Status</label>
					<form:select id="userrole_status" path="usersRole.userrole_status" class="form-control">
						<form:option value="Active"> Active </form:option>
						<form:option value="Inactive"> Inactive </form:option>
					</form:select>
				</div>							
				
				<button type="submit" class="btn btn-default" onclick="updateUsersRole('${loader}', '${usersRole.ur_id}')">Update</button>
<%-- 			</frm:form>	 --%>
